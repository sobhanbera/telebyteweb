...
const TermsAndCondition = () => {
	return (
		<div className={styles.mainPrivacy}>
			<div className={styles.privacyStarting}>
				<div className={styles.privacyHeader}>
					<h1>
						Socbyte <strong>Terms and Conditions</strong>
					</h1>
				</div>

				<p>Welcome to Socbyte!</p>

				<p>
					These terms and conditions outline the rules and regulations for the use of
					Socbyte's Website, located at https://telebyte.vercel.app/.
				</p>

				<p>
					By accessing this website we assume you accept these terms and conditions. Do
					not continue to use Socbyte if you do not agree to take all of the terms and
				...
				<p>
					Registration. We may ask you to register an account for the use of our services.
					In registering, you may elect to create an account with us or, if possible,
					create an account via a third party service such as Facebook. You understand and
					acknowledge that if you create an account using any third party services, you
					will be subject to those terms and conditions as well as privacy policies in
					connection with the use of our Services. You agree to familiarize yourself with
					any obligations under the conditions set forth by using the third party services
					as it relates to registration. Terms of Account. You may be required to register
					an account with us for the proposes of using our services. You agree that the
					information you provide is accurate to the best of your knowledge. You must be
					at least 18 years of age or emancipated according to the local jurisdiction. You
					will be required certain personal information to us as part of your account. You
					agree to maintain the information as to its accuracy. Failure to maintain an
					up-to-date account may result in your inability to use our services. You are
					solely responsible for all activity that occurs on your account. Use of Account.
					You agree to use your account exclusively for the benefit of our services. You
					further agree that you do not allow any third party to use your account or use
					your account for any services not associated with your personal property or
					property for which you have lawful control. You agree that you will use our
					services for only lawful activities. You agree, as needed, to offer proof of
					identity in completing the services to ensure that you match the details on the
					account. Privacy. The terms of your account shall be protected by our privacy
					policy including any user generated material or confidential information
					provided as part of your account. To learn more about how we use your data,
					please refer to our privacy policy which is incorporated into this agreement by
					reference.
				</p>

				<h2>WARRANTIES AND LIMITATIONS ON LIABILITY</h2>
				<p>
					USE OF THE SERVICES IS AT YOUR OWN RISK. THE SERVICES ARE PROVIDED ON AN "AS IS"
					AND "AS AVAILABLE" BASIS. WE EXPRESSLY DISCLAIM ALL WARRANTIES OF ANY KIND,
					WHETHER EXPRESS OR IMPLIED, INCLUDING, BUT NOT LIMITED TO, THE IMPLIED
					WARRANTIES OF TITLE, MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE AND
					NON-INFRINGEMENT. WE MAKE NO WARRANTY THAT (i) THE SERVICES OR ANY PRODUCTS
					PURCHASED THROUGH THE SERVICES WILL MEET YOUR REQUIREMENTS; (ii) THE SERVICES
					WILL BE UNINTERRUPTED, TIMELY, SECURE OR ERROR-FREE; OR (iii) THAT THE SERVICE
					WILL BE ERROR FREE OR THAT WE WILL FIX ANY ERRORS. ANY MATERIALS OBTAINED
					THROUGH USE OF THE SERVICES ARE OBTAINED AT YOUR OWN DISCRETION AND RISK AND THE
					COMPANY SHALL NOT BE RESPONSIBLE FOR ANY DAMAGE CAUSED TO YOUR COMPUTER OR DATA
					OR FOR ANY BUGS, VIRUSES, TROJAN HORSES OR OTHER DESTRUCTIVE CODE RESULTING FROM
					USE OF THE SERVICES OR ANY CONTENT OBTAINED FROM THE SERVICES. SOME STATES DO
					NOT ALLOW THE EXCLUSION OF IMPLIED WARRANTIES, SO THE ABOVE EXCLUSION MAY NOT
					APPLY TO YOU. YOU MAY ALSO HAVE OTHER LEGAL RIGHTS, WHICH VARY FROM STATE TO
					STATE. TO THE FULLEST EXTENT PERMITTED UNDER LAW, WE HAVE NO OBLIGATION OR
					LIABILITY (WHETHER ARISING IN CONTRACT, WARRANTY, TORT (INCLUDING NEGLIGENCE),
					PRODUCT LIABILITY OR OTHERWISE) FOR ANY INDIRECT, INCIDENTAL, SPECIAL, PUNITIVE,
					OR CONSEQUENTIAL DAMAGES OR LIABILITIES (INCLUDING, BUT NOT LIMITED TO, ANY LOSS
					OF DATA, REVENUE OR PROFIT) ARISING FROM OR RELATED TO YOUR USE OF THE SERVICES
					OR ANY CONTENT PROVIDED BY OR THROUGH THE SERVICES, EVEN IF WE HAVE BEEN ADVISED
					OF THE POSSIBILITY OF SUCH DAMAGES IN ADVANCE. THE FOREGOING LIMITATION APPLIES
					TO DAMAGES ARISING FROM (i) YOUR USE OR INABILITY TO USE OUR SERVICES; (ii) COST
					OF PROCUREMENT OF SUBSTITUTE GOODS AND SERVICES RESULTING FROM ANY GOODS OR
					SERVICES PURCHASED THROUGH OR FROM OUR SERVICES; (iii) THIRD PARTY CONTENT MADE
					AVAILABLE TO YOU THROUGH THE SERVICES; OR (iv) ANY OTHER MATTER RELATING TO THE
					SERVICES. SOME STATES DO NOT ALLOW THE LIMITATION OR EXCLUSION OF INCIDENTAL,
					CONSEQUENTIAL OR OTHER TYPES OF DAMAGES, SO SOME OF THE ABOVE LIMITATIONS MAY
					NOT APPLY TO YOU. NOTWITHSTANDING ANYTHING TO THE CONTRARY CONTAINED HEREIN, OUR
					LIABILITY AND THE LIABILITY OF EACH OF OUR OFFICERS, MANAGERS, INVESTORS,
					EMPLOYEES, AGENTS, ADVERTISERS, LICENSORS, SUPPLIERS, SERVICE PROVIDERS AND
					OTHER CONTRACTORS TO YOU OR ANY THIRD PARTIES UNDER ANY CIRCUMSTANCE IS LIMITED
					TO A MAXIMUM AMOUNT OF $500. CERTAIN STATE LAWS DO NOT ALLOW LIMITATIONS ON
				...
				<p>
					We employ the use of cookies. By accessing Socbyte, you agreed to use cookies in
					agreement with the Socbyte's Privacy Policy.{' '}
				</p>
				...
				<p>
					Unless otherwise stated, Socbyte and/or its licensors own the intellectual
					property rights for all material on Socbyte. All intellectual property rights
					are reserved. You may access this from Socbyte for your own personal use
					subjected to restrictions set in these terms and conditions.
				</p>

				<p>You must not:</p>
				<ul>
					<li>Republish material from Socbyte</li>
					<li>Sell, rent or sub-license material from Socbyte</li>
					<li>Reproduce, duplicate or copy material from Socbyte</li>
					<li>Redistribute content from Socbyte</li>
				</ul>

				<p>
					Parts of this website offer an opportunity for users to post and exchange
					opinions and information in certain areas of the website. Socbyte does not
					filter, edit, publish or review Comments prior to their presence on the website.
					Comments do not reflect the views and opinions of Socbyte,its agents and/or
					affiliates. Comments reflect the views and opinions of the person who post their
					views and opinions. To the extent permitted by applicable laws, Socbyte shall
				...
				<p>
					Socbyte reserves the right to monitor all Comments and to remove any Comments
				...
				<p>
					You hereby grant Socbyte a non-exclusive license to use, reproduce, edit and
				...
				<p>
					...
					of Socbyte; and (d) the link is in the context of general resource information.
				</p>
				...
				<p>
					...
					Socbyte. Please include your name, your organization name, contact information
				...
				<p>
					No use of Socbyte's logo or other artwork will be allowed for linking absent a

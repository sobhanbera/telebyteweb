		...
		<div className={styles.mainPrivacy}>
			<div className={styles.privacyStarting}>
				<div className={styles.privacyHeader}>
					<h1>
						Socbyte <strong>Privacy Policy</strong>
					</h1>
				</div>
				<p>
					Socbyte, ("we”, “us”, or “our") provides this Privacy Policy to inform you of
					our policies and procedures regarding the collection, use and disclosure of
					personal information we may receive from users of our website (“Site”) or of our
					android application ("App") and any other services offered by us in connection
					with our site (any and all of the foregoing the "Services").
				</p>
				<p>
				...
				<p>
					...
					information, in the form of Persistent Identifiers, including IP Address. We
					collect and stores this personal information solely for the purpose of providing
				...
				<ul>
					...
					<li>
						<p>
							<strong>Website</strong> refers to Socbyte, accessible from{' '}
							<a
								href='https://telebyte.vercel.app'
								rel='external nofollow noopener'
								target='_blank'>
								https://telebyte.vercel.app
							</a>{' '}
							*Currently Servers Are Down
						</p>
					</li>
					<li>
						<p>
				...
				<p>
					We are concerned with the security of your personal information and are
					committed to taking reasonable steps to protect it from unauthorized access and
					use. To that end, we put in place the appropriate physical, electronic and
					managerial policies and procedures designed to secure Personal Information. We
					also continue to implement procedures to maintain accurate, complete and current
					Personal Information. No method of transmission over the Internet, or method of
					electronic storage, is one hundred percent secure. Therefore, while we strive to
					use commercially acceptable means to protect Personal Information, we cannot
				...
				<h1>Contact Us</h1>
				<p>
					Please contact us with any questions or comments about this Privacy Policy, Our
					Privacy Policy Toward Children, your personal information, and our third-party
					disclosure practices, at{' '}
					<a
						href='mailto:contactdevelopersb@gmail.com'
						rel='external nofollow noopener'
						target='_blank'>
						contactdevelopersb@gmail.com
					</a>{' '}
					*Currently Servers Are Down
				</p>
				...
				<p>
					Privacy Policy Will Change Soon. Whenever a new feature or any new patch comes
					in realease.
				</p>
